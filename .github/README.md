...
[`@aws-sdk/client-rum`](https://www.npmjs.com/package/@aws-sdk/client-rum/v/3.81.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-rum@3.81.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dVIDMWeGnY/Bd6+HQCMBEqPL1chHUBB36IF01/bwwTChNCUVlZPb98dvUFytYp22
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-rum": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-rum@3.81.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-rum@3.81.0/index.min.mjs": "sha384-dVIDMWeGnY/Bd6+HQCMBEqPL1chHUBB36IF01/bwwTChNCUVlZPb98dvUFytYp22"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-rum/blob/refs/tags/3.81.0/LICENSE
```
