...
[`@aws-sdk/client-rum`](https://www.npmjs.com/package/@aws-sdk/client-rum/v/3.675.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-rum@3.675.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/0IfvL8gmR/l5JPfyGya3C/Bf8tzDQSwL1X3GFCdzZnRB4wUzgOPtekF0HbhNA+b
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-rum": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-rum@3.675.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-rum@3.675.0/index.min.mjs": "sha384-/0IfvL8gmR/l5JPfyGya3C/Bf8tzDQSwL1X3GFCdzZnRB4wUzgOPtekF0HbhNA+b"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-rum/blob/refs/tags/3.675.0/LICENSE
```
